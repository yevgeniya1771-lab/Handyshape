...
export function HeroCarousel() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-background pb-0 -mt-[1px]">
      <div ref={scrollRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide pt-12 sm:pt-16 lg:pt-20 pb-0">
        {HERO_SLIDES.map((slide, index) => (
          <div key={index} className="min-w-full snap-center pb-0 relative">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 min-h-[500px] relative">
              <div className="text-center lg:text-left mb-8 lg:mb-0 relative z-10 pt-12">
                ...
                <p className="mt-4 sm:mt-6 text-pretty text-base sm:text-lg leading-relaxed text-muted-foreground max-w-xl mx-auto lg:mx-0">
                  {slide.description}
                </p>
